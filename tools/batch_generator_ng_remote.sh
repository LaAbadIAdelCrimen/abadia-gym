...
(gsutil cat  "gs://abadia-data/all_checkpoint_list.txt" | sed -e 's/https:\/\/storage.googleapis.com\/abadia-data\///g'| egrep "_$1_[0-9]_0.c|_36_[0-9][0-9]_0.c" | grep -v "_0_0.che" | head -100) |
while read -r line
do
  case $line in
    *_0_0.c*)
