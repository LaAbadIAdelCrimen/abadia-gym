...
dqn_agent = AbadIA.NGDQN.NGDQN(env=None, initModelName="models/pre_last_model_v7.model", modelName="models/pre_last_model_v7.model")

print("Loading some vectors from a dir --> {}".format(sys.argv[1]))
dqn_agent.load_vectors_from_a_dir(sys.argv[1])

print("Training with replay_game"training_NGDQN.py)
